...
The first step is to load the data (in the `/data/` folder). What kind of data is it? What command will you use? Don't forget to load any libraries you might need.
...
Evaluate your learner on the training set and the test set. How well did it do on both datasets? Does the test data give you any confidence that you built a good learner? What is your interpretation of the results? Do you think the problem is an easy or hard one? How did the learner do?

```{r}
##write any evaluation code here.
```

If you have time. ompare your results on classifying the test set with both algorithms (LDA and Classification Trees). Is there a way to see compare the misclassifcations? Did both algorithms do equally well?