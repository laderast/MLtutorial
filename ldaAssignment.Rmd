...
=======
The first step is to load the data (in the `/data/` folder). What kind of data is it? What command will you use? Don't forget to load any libraries you might need. If you need help 
>>>>>>> a4fd0d8b8dc8f2ab3f7f4cb374d56832f13983d2
